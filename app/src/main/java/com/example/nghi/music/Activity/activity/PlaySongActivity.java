...
//        mImgPlay.setBackground(ContextCompat.getDrawable(getBaseContext(),R.drawable.ic_pause_press));
        ...
        switch (id) {
            ...
            case R.id.imageRepeat: {
                ...
                if (mRepeat.equals(String.valueOf(Repeat.REPEAT))) {
                    ...
                    mEditor.commit();
//                    mImgRepeat.setBackground(getResources().getDrawable(R.drawable.bg_button_unrepeat));
                ...
                if (mRepeat.equals(String.valueOf(Repeat.UNREPEAT))) {
                    ...
                    mEditor.commit();
                   // mImgRepeat.setBackground(getResources().getDrawable(R.drawable.bg_button_repeat_one));
                ...
                if (mRepeat.equals(String.valueOf(Repeat.ONE))) {
                    ...
                    mEditor.commit();
//                    mImgRepeat.setBackground(getResources().getDrawable(R.drawable.bg_button_repeat));
            ...
            case R.id.imageShuffle: {
                if (mShuffle.equals(String.valueOf(Shuffle.SHUFFLE))) {
                    ...
                    mEditor.commit();
//                    mImgShuffle.setBackground(getResources().getDrawable(R.drawable.bg_button_noshuffle));
                ...
                if (mShuffle.equals(String.valueOf(Shuffle.NOSHUFFLE))) {
                    ...
                    mEditor.commit();
//                    mImgShuffle.setBackground(getResources().getDrawable(R.drawable.bg_button_shuffle));
